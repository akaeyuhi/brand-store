  ...
  return (
    <div className='about container'>
      ...
      <div className='about__links'>
        ...
        <div className='about__links__block'>
          <Link to='/'
                className='about__header_link link'>INFORMATION</Link><br />
          <Link to='/' className='about__link link'>Tearms &
            Condition</Link><br />
        ...
        <div className='about__links__block'>
          <Link to='/products' className='about__header_link link'>SHOP
            CATEGORY</Link><br />
          ...
          <Link to='/products.html' className='about__link link'>Brows
            All</Link>
        </div>
      </div>
    </div>
